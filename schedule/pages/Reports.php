			...
			<tr>
				...
				<td>
					<select name="kksudahproses" class="form-control select2" required>
						...
						<option value="1" <?php if ($_POST['kksudahproses'] == '1') {
												echo "SELECTED";
											} ?>>Tampilkan
							Semua</option>
						<option value="2" <?php if ($_POST['kksudahproses'] == '2') {
												echo "SELECTED";
											} ?>>Hanya
							tampilkan data sudah proses</option>
						<option value="3" <?php if ($_POST['kksudahproses'] == '3') {
												echo "SELECTED";
											} ?>>Hanya
			...
			<tr>
				...
				<td>
					<select name="nourut" class="form-control select2" required>
						<option value="" disabled selected>Pilih</option>
						<option value="with0" <?php if ($_POST['nourut'] == 'with0') {
													echo "SELECTED";
												} ?>>Semua nomor
							urut dengan 0</option>
						<option value="without0" <?php if ($_POST['nourut'] == 'without0') {
														echo "SELECTED";
													} ?>>Semua
				...
				<?php while ($row_schedule  = sqlsrv_fetch_array($q_schedule, SQLSRV_FETCH_ASSOC)) : ?>
					...
					<?php if (empty($data_proses['jml']) and $_POST['kksudahproses'] == '3') : ?>
						<tr>
							...
							<td style="border:1px solid;vertical-align:middle; text-align: center;">
								<?= $row_schedule['creationdatetime']->format('Y-m-d H:i:s') ?></td>
							<td style="border:1px solid;vertical-align:middle; text-align: left;">
								...
								<?php if ($data_hasilproses) {
									echo "<span style='color: red;'><b>Sudah Jalan</b></span>";
								} ?><br>
