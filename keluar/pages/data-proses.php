...
if(isset($_POST['btnHapus'])){
		$hapusSql = "DELETE FROM tbl_proses_keluar WHERE id='$_POST[id]'";
...
if(isset($_POST['btnSimpan'])){
	...
	$simpanSql = "INSERT INTO tbl_proses_keluar SET 
	`proses`='$proses',
	`jns`='$jns',
	`ket`='$ket'";
...
if(isset($_POST['btnUbah'])){
		$proses=$_POST[proses];
		$ket=str_replace("'","",$_POST[ket]);
	$simpanSql = "UPDATE tbl_proses_keluar SET 
	`proses`='$proses',
	`ket`='$ket'
	WHERE `id`='$_POST[id]'";
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <?php $qtampil=mysql_query("SELECT * FROM tbl_proses_keluar WHERE proses='$_GET[proses]' AND jns='$_GET[jns]' LIMIT 1");
...
<table width="100%" border="0">
  ...
  <?php 
  $qry=mysql_query("SELECT * FROM tbl_proses_keluar ORDER BY id ASC");
  $no=1;
