...
<body>
  ...
  if (isset($_POST['btnSimpan'])) {
    ...
    $simpanSql = "INSERT INTO db_finishing.tbl_mesin SET (nama,ket) VALUES ('$mesin','$ket')";
  ...
  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
    <table width="100%" border="0">
      ...
      <?php $qtampil = sqlsrv_query($con, "SELECT TOP 1 * FROM db_finishing.tbl_mesin WHERE nama='$_GET[nama]' ", array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
