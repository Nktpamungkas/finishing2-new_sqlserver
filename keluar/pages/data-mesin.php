...
<body>
  ...
  if (isset($_POST['btnSimpan'])) {
    ...
    $simpanSql = "INSERT INTO db_finishing.tbl_no_mesin (no_mesin, ket) VALUES ('$no_mesin', '$ket')";
  ...
  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
    <table width="100%" border="0">
      ...
      <?php $qtampil = sqlsrv_query($con, "SELECT TOP 1 * FROM db_finishing.tbl_no_mesin WHERE no_mesin='$_GET[no_mesin]'", array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
