...
<body>
  ...
  if (isset($_POST['btnSimpan'])) {
    ...
    $simpanSql = "INSERT INTO db_finishing.tbl_stop_mesin(kode,ket)VALUES(?,?)";
  ...
  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
    <table width="100%" border="0">
      ...
      <?php $qtampil = sqlsrv_query($con, "SELECT TOP 1 * FROM db_finishing.tbl_stop_mesin WHERE kode='$_GET[kode]'", array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
      ...
      <tr>
        ...
        <td width="78%"><label for="kode"></label>
          <input type="text" name="kode" id="kode" onchange="window.location='data-stop.php?kode='+this.value"
            value="<?php echo $_GET['kode']; ?>" required="required" />
