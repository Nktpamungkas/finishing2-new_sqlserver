...
<input type="button" name="button3" id="button3" value="Cetak" onclick="window.open('pages/reports-adm-cetak.php?tglawal=<?php echo $tglawal; ?>&amp;tglakhir=<?php echo $tglakhir; ?>&amp;shift=<?php echo $shft; ?>', '_blank')" class="art-button"/>
...
WHERE
   ...
   $c=0;
    while($rowd=mysql_fetch_array($sql)){
      ...
      <td ><input type="button" name="hapus" id="hapus" value="Hapus" onClick="confirmDelete('?p=hapus-report&id=<?php echo $rowd[idp];?>&tgl1=<?php echo $tglawal;?>&tgl2=<?php echo $tglakhir;?>&shift=<?php echo $shft;?>&jenis=Kartu IN');"/>
        <input type="button" name="ubah" id="ubah" value="ubah" onclick="confirmEdit('?p=edit-report&amp;id=<?php echo $rowd[idp];?>&amp;tgl1=<?php echo $tglawal;?>&amp;tgl2=<?php echo $tglakhir;?>&amp;shift=<?php echo $shft;?>&amp;jenis=Kartu IN');"/></td>
    </tr>
     <?php 
...
<table width="100%" border="0" id="datatables" class="display" >
   <thead>
    <tr >
      <td width="4%" bgcolor="#99FF99" ><div align="center"><strong><font size="-2">TGL MASUK</font></strong></div></td>
      <td width="4%" bgcolor="#99FF99" ><div align="center"><strong><font size="-2">JAM MASUK</font></strong></div></td>
      ...
      <td width="3%" bgcolor="#99FF99" ><div align="center"><strong><font size="-2">LOT</font></strong></div></td>
      ...
      <td width="9%" bgcolor="#99FF99" ><div align="center"><strong><font size="-2">PROSES DEPT. BERIKUTNYA</font></strong></div></td>
      <td width="9%" bgcolor="#99FF99" ><div align="center"><strong><font size="-2">AKSI</font></strong></div></td>
    </tr>
    </thead>
    <tbody>
    <?php 
...
<table width="100%" border="0" id="datatables" class="display">
   <thead>
    <tr >
      ...
      <td width="10%" bgcolor="#99FF99"><div align="center"><strong><font size="-2">AKSI</font></strong></div></td>
    </tr>
    </thead>
    <tbody>
    <?php 
