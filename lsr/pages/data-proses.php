  ...
  ?>
    <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0">
            ...
            <?php $qtampil = sqlsrv_query($con, "SELECT TOP 1 * FROM db_finishing.tbl_proses WHERE proses='$_GET[proses]' AND jns='$_GET[jns]'", array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
