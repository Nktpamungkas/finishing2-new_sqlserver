...
if(isset($_POST['btnHapus'])){
		$hapusSql = "DELETE FROM db_finishing.tbl_proses WHERE id='$_POST[id]'";
...
if(isset($_POST['btnUbah'])){
		$proses=$_POST['proses'];
		$ket=str_replace("'","",$_POST['ket']);
	$simpanSql = "UPDATE db_finishing.tbl_proses SET 
	`proses`='$proses',
	`ket`='$ket'
	WHERE `id`='$_POST[id]'";
    ...
    <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0">
            ...
            <?php $qtampil=sqlsrv_query($con,"SELECT TOP 1 * FROM db_finishing.tbl_proses WHERE proses='$_GET[proses]' AND jns='$_GET[jns]'");
	...
	?>
            <tr>
                ...
                <td width="78%"><label for="proses"></label>
                    <input type="text" name="proses" id="proses"
                        onchange="window.location='data-proses.php?proses='+this.value"
                        value="<?php echo $_GET['proses'];?>" required="required" />
            ...
            <tr>
                ...
                <td><select name="jns" id="jns"
                        onchange="window.location='data-proses.php?proses=<?php echo $_GET['proses'];?>&jns='+this.value"
                        required="required">
        ...
        <table width="100%" border="0">
            ...
            <?php 
  $qry=sqlsrv_query($con,"SELECT * FROM db_finishing.tbl_proses ORDER BY id ASC");
  $no=1;
