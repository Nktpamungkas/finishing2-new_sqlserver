...
if(isset($_POST['btnHapus'])){
		...
		sqlsrv_query($con,$hapusSql) or die ("Gagal hapus".mysqli_error());
...
if (isset($_POST['btnSimpan'])) {
  ...
  $simpanSql = "INSERT INTO db_finishing.tbl_staff (kode, ket) VALUES (?, ?)";
...
if(isset($_POST['btnUbah'])){
    ...
    <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0">
            ...
            <?php $qtampil=sqlsrv_query($con,"SELECT TOP 1 * FROM db_finishing.tbl_chemical WHERE kode='$_GET[kode]'");
            ...
            <tr>
                ...
                <td width="78%"><label for="kode"></label>
                    <input type="text" name="kode" id="kode"
                        onchange="window.location='data-chemical.php?kode='+this.value"
