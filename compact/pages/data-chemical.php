...
<body>
    ...
    if (isset($_POST['btnSimpan'])) {
        ...
        $simpanSql = "INSERT INTO db_finishing.tbl_chemical (kode, ket) VALUES (?, ?)";
    ...
    <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0">
            ...
            <?php $qtampil = sqlsrv_query($con, "SELECT * FROM db_finishing.tbl_chemical WHERE kode='$_GET[kode]' LIMIT 1");
