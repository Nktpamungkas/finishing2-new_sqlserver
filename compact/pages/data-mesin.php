...
<body>
    ...
    <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0">
            ...
            <?php
            if (isset($_GET['no_mesin']) && !empty($_GET['no_mesin'])) {
                $sql = "SELECT TOP 1 * FROM db_finishing.tbl_no_mesin WHERE no_mesin = ?";
                $params = array($_GET['no_mesin']);
                $qtampil = sqlsrv_query($con, $sql, $params, array("Scrollable" => SQLSRV_CURSOR_KEYSET));
