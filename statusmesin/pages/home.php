...
<body>
    ...
    <div class="card">
                ...
                <table border="0" width="100%">
                    <thead>
                        <tr>
                            <th>
                                <?php
                                $q_schedule_sum = sqlsrv_query($con, "SELECT
                                                    ...
                                                    WHERE
                                                        ...
                                                        AND a.nourut <> 0");
                                $row_sum_qty = sqlsrv_fetch_array($q_schedule_sum);
                                ?>
                                <span
                    ...
                    <tbody>
                        <?php
                        $q_schedule = sqlsrv_query($con, "SELECT TOP 10
                                                                    * 
                                                                FROM
                                                                   db_finishing.tbl_schedule_new a
                                                                WHERE
                                                                ...
                                                                ORDER BY
                                                                    CONCAT(
                                                                        SUBSTRING(TRIM(a.no_mesin), - 5, 2),
                                                                    SUBSTRING(TRIM(a.no_mesin), - 5,2 )) ASC,
                                                                    nourut ASC");

                        $q_schedule_10 = sqlsrv_query($con, "SELECT 
                                                                    * 
                                                                FROM
                                                                   db_finishing.tbl_schedule_new a
                                                                WHERE
                                                                ...
                                                                ORDER BY
                                                                    CONCAT(
                                                                        SUBSTRING(TRIM(a.no_mesin), - 5, 2),
                                                                    SUBSTRING(TRIM(a.no_mesin), - 5,2 )) ASC,
                                                                    nourut ASC OFFSET 10 ROWS FETCH NEXT 100 ROWS ONLY");
                        $row_schedule_10 = sqlsrv_fetch_array($q_schedule_10);
                        ?>
                        <?php while ($row_schedule = sqlsrv_fetch_array($q_schedule)): ?>
                            <?php
                            $q_proses = sqlsrv_query($con, "SELECT * FROM db_finishing.tbl_proses WHERE CONCAT(proses, ' (', jns, ')') = '$row_schedule[proses]'");
                            $row_proses = sqlsrv_fetch_array($q_proses);
                            ...
                            <tr>
                                <td>
                                    <?php
                                    $status_mesin = sqlsrv_query($con, "SELECT proses, langganan, warna, lot, no_order, qty_order FROM db_finishing.tbl_schedule_new WHERE nodemand = '$row_schedule[nodemand]' AND operation = '$row_schedule[operation]'");
                                    $row_statusmesin = sqlsrv_fetch_array($status_mesin);
                                    ?>
                                    <div class="kolom"
                ...
                <table border="0" width="100%">
                    <thead>
                        <tr>
                            <th>
                                <?php
                                $q_schedule_sum = sqlsrv_query($con, "SELECT TOP 10
                                                                            SUM(qty_order) AS sum_qty
                                                                        FROM
                                                                            db_finishing.tbl_schedule_new a 
                                                                        WHERE
        ...
        <?php
        $q_data1 = sqlsrv_query($con, "SELECT 
                                                    SUM(qty_order) AS sum_qty,
                                                    p.ket_proses AS ket_proses
                                            FROM
                                                    db_finishing.tbl_schedule_new a 
                                            LEFT JOIN db_finishing.tbl_proses p ON CONCAT(p.proses, ' (', p.jns, ')') = a.proses
                                            WHERE
                                                    NOT EXISTS (
                                                    SELECT
                                                            1 
                                            ...
                                            GROUP BY 
                                                p.ket_proses");
        $data1 = sqlsrv_fetch_array($q_data1);

        $q_data2 = sqlsrv_query($con, "SELECT
                                                    SUM(qty_order) AS sum_qty,
                                                    p.ket_proses AS ket_proses
                                            FROM
                                                    db_finishing.tbl_schedule_new a 
                                            ...
                                            GROUP BY 
                                                p.ket_proses");
        $data2 = sqlsrv_fetch_array($q_data2);

        $q_data3 = sqlsrv_query($con, "SELECT
                                                    SUM(qty_order) AS sum_qty,
                                                    p.ket_proses AS ket_proses
                                            FROM
                                                    db_finishing.tbl_schedule_new a 
                                            ...
                                            GROUP BY 
                                                p.ket_proses");
        $data3 = sqlsrv_fetch_array($q_data3);

        $q_data4 = sqlsrv_query($con, "SELECT
                                                    SUM(qty_order) AS sum_qty,
                                                    p.ket_proses AS ket_proses
                                            FROM
                                                    db_finishing.tbl_schedule_new a 
                                            ...
                                            GROUP BY 
                                                p.ket_proses");
        $data4 = sqlsrv_fetch_array($q_data4);
        ?>
                    ...
                    <tbody>
                        ...
                        <?php while ($row_schedule = sqlsrv_fetch_array($q_schedule)): ?>
                            ...
                            <tr>
                                <td>
                                    <?php
                                    $status_mesin = sqlsrv_query($con, "SELECT proses, langganan, warna, lot, no_order, qty_order FROM db_finishing.tbl_masuk WHERE nodemand = '$row_schedule[nodemand]' AND operation = '$row_schedule[operation]'");
                                    $row_statusmesin = sqlsrv_fetch_array($status_mesin);
                                    ?>
                                    <div class="kolom"
                                        title="<?= (htmlspecialchars($row_statusmesin['proses'] . "\n" . $row_statusmesin['langganan'] . "\n" . $row_statusmesin['warna'] . "\n" . $row_statusmesin['lot'] . "\n" . $row_statusmesin['no_order'] . "\n" . $row_statusmesin['qty_order'])); ?>"
                    ...
                    <tbody>
                        ...
                        $q_schedule_10 = sqlsrv_query($con, "SELECT
                                                                            ...
                                                                            WHERE
                                                                                ...
                                                                                AND a.prosesbc = 'BC02' ORDER BY a.nokk
                                                                           OFFSET 10 ROWS FETCH NEXT 100 ROWS ONLY");
                        $row_schedule_10 = sqlsrv_fetch_array($q_schedule_10);
                        ?>
                        <?php while ($row_schedule = sqlsrv_fetch_array($q_schedule)): ?>
                    ...
                    <tbody>
                        ...
                        $q_schedule_10 = sqlsrv_query($con, "SELECT
                                                                        ...
                                                                        WHERE
                                                                            ...
                                                                            AND a.prosesbc = 'BC03' ORDER BY a.nokk
                                                                       OFFSET 10 ROWS FETCH NEXT 100 ROWS ONLY");
                        $row_schedule_10 = sqlsrv_fetch_array($q_schedule_10);
                        ?>
                        <?php while ($row_schedule = sqlsrv_fetch_array($q_schedule)): ?>
                    ...
                    <tbody>
                        ...
                        $q_schedule_10 = sqlsrv_query($con, "SELECT
                                                            ...
                                                            WHERE
                                                                ...
                                                                AND a.prosesbc = 'BC04'  ORDER BY a.nokk
                                                           OFFSET 10 ROWS FETCH NEXT 100 ROWS ONLY");
                        $row_schedule_10 = sqlsrv_fetch_array($q_schedule_10);
                        ?>
                        <?php while ($row_schedule = sqlsrv_fetch_array($q_schedule)): ?>
