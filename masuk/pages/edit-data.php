...
<body>
    <?PHP
	include('../koneksi.php');
	$q_kkmasuk = sqlsrv_query($con, "SELECT * FROM db_finishing.tbl_masuk WHERE id = '$_GET[id]'");
	...
	if (isset($_POST['btnSimpan'])) {
		...
		$prosesbc = $_POST['prosesbc'];
		$lastupdatedatetime = date('Y-m-d H:i:s');
		$akun = $_SESSION['usr'];
		$simpanSql = "UPDATE db_finishing.tbl_masuk
								SET operation = '$operation',
									...
									prosesbc = '$prosesbc'
								WHERE id = " . $_GET['id'];
		$simpan = sqlsrv_query($con, $simpanSql);
		...
		if ($simpan) {
			echo "<script>
							swal({
								...
								if (result.value) {
									window.location.href = 'http://localhost/finishing2-new_sqlserver/masuk/index.php?p=LihatData'; 
								}
							});
						</script>";
		}
        ...
        <fieldset>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td width="1%">:</td>
                    <td>
                        <select style="width: 50%" id="nokk" name="nokk" onchange="window.location='?nokk='+this.value"
                            required disabled>
                ...
                <tr>
                    ...
                    <td width="1%">:</td>
                    <td width="26%">
                        <input name="nokk" type="text" id="nokk" size="17" value="<?php echo $row_kkmasuk['nokk']; ?>"
                            name="id" disabled style="background-color: #BBBBBB ;" />
                        <input name="nokk" type="text" id="nokk" size="17"
                            value="<?php echo $row_kkmasuk['nodemand']; ?>" name="id" disabled
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="buyer" type="text" id="buyer" size="45"
                            value="<?php echo $row_kkmasuk['langganan']; ?> / <?php echo $row_kkmasuk['buyer']; ?>"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="no_order" id="no_order" value="<?php echo $row_kkmasuk['no_order']; ?>"
                            disabled style="background-color: #BBBBBB;" />
                    </td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="date" name="tgl_delivery" value="<?php if ($row_kkmasuk['tgl_delivery'] != null or $row_kkmasuk['tgl_delivery'] != '') {
								echo $row_kkmasuk['tgl_delivery']->format('Y-m-d');
							}
							echo ''; ?>" disabled style="background-color: #BBBBBB;" />
                    </td>
                    ...
                    <td>:</td>
                    <td><input name="roll" type="text" id="roll" size="3" placeholder="0" pattern="[0-9]{1,}"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="jenis_kain" cols="35" id="jenis_kain" disabled
                            style="background-color: #BBBBBB;"><?php echo $row_kkmasuk['jenis_kain']; ?></textarea>
                    </td>
                    <td valign="top">
                    ...
                    <td colspan="2" valign="top">
                        <textarea name="catatan" cols="35"
                            id="catatan"><?php echo $row_kkmasuk['catatan']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                    ...
                    <td>
                        <input name="no_warna" type="text" id="no_warna" size="35"
                            value="<?php echo $row_kkmasuk['no_warna']; ?>" disabled
                            style="background-color: #BBBBBB;" />
                    </td>
                    ...
                    <td colspan="2">
                        ...
                        <input name="qty_order" type="text" id="qty_order" size="5"
                            value="<?php echo $row_kkmasuk['qty_order']; ?>" placeholder="qty_order" disabled
                            style="background-color: #BBBBBB;" />
                        &nbsp;&nbsp;&nbsp;&nbsp;<strong>Gramasi</strong>:
                        <input name="lebar" type="text" id="lebar" size="6"
                            value="<?php echo $row_kkmasuk['gramasi']; ?>" placeholder="gramasi" disabled
                            style="background-color: #BBBBBB;" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="warna" type="text" id="warna" size="35"
                            value="<?php echo $row_kkmasuk['warna']; ?>" disabled style="background-color: #BBBBBB;" />
                    </td>
                    <td width="14%"><strong>Panjang (Yard)</strong></td>
                    <td>:</td>
                    <td colspan="2"><input name="qty2" type="text" id="qty2" size="8"
                            value="<?= $row_kkmasuk['qty_order_yd']; ?><?php echo $row_kkmasuk['panjang']; ?>"
                            placeholder="0.00" onfocus="jumlah();" disabled style="background-color: #BBBBBB;" /></td>
                </tr>
                <tr>
                    <td scope="row">
                        <h4>Lot</h4>
                    ...
                    <td>:</td>
                    <td><input name="lot" type="text" id="lot" size="5" value="<?php echo $row_kkmasuk['lot']; ?>"
                            disabled style="background-color: #BBBBBB;" /></td>
                    <td>
