...
if(isset($_POST['btnHapus'])){
		$hapusSql = "DELETE FROM tbl_proses_masuk WHERE id='$_POST[id]'";
...
if(isset($_POST['btnSimpan'])){
	...
	$simpanSql = "INSERT INTO tbl_proses_masuk SET 
	`proses`='$proses',
	`jns`='$jns',
	`ket`='$ket'";
...
if(isset($_POST['btnUbah'])){
		$proses=$_POST['proses'];
		$ket=str_replace("'","",$_POST['ket']);
	$simpanSql = "UPDATE tbl_proses_masuk SET 
	`proses`='$proses',
	`ket`='$ket'
	WHERE `id`='$_POST[id]'";
...
<table width="100%" border="0">
  ...
  <?php 
  $qry=mysqli_query($con,"SELECT * FROM tbl_proses_masuk ORDER BY id ASC");
  $no=1;
